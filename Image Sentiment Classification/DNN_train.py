...
model.summary()
#load model 
#model.load_weights('ckpt/weights.071-0.71767.h5')
#Compole the model
...
#Callbacks
callbacks = []
modelcheckpoint = ModelCheckpoint('ckpt/dnn_weights.{epoch:03d}-{val_acc:.5f}.h5', monitor='val_acc', save_best_only=True)
